...
public class MapActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        send = (Button) findViewById(R.id.map_send);
        reset = (Button) findViewById(R.id.map_Reset);
        editDestination = (EditText) findViewById(R.id.map_edit);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.map_Reset:
                ...
                break;
            case R.id.map_send:
                mapDaoHang(editDestination.getText().toString(), MapActivity.this);
                break;
        }
    }

    public static void mapDaoHang(String endAddress, Context context) {
        String address = "address=" + endAddress;
        /**调用百度地图Web页面
